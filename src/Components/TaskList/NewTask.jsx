...
const NewTask = ({data}) => {
  return (
    ...
    <p className="text-sm mt-1 min-h-20 "> {data.description || data.taskDescription} </p>
    <div className='mt-6'>
        <button className='bg-green-400 py-1 px-2 text-sm rounded-md'>Accept Task</button>
    </div>
  </div>
  )
}
